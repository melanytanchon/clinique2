					...
					<center>
						<fieldset><BR>
							...
							<fieldset>
								...
								<span class="cont_phone"><?php
									echo "Questionnaire en ligne: ".$rep 
								?></span><br>
							</fieldset><BR>
							<fieldset><BR>
								<a href="modifierMDPMedecin.php"><b>Modifier mon compte</b></a>
							</fieldset>
						</fieldset></center></div>
							<fieldset>
			...
			<div class="grid_4">
				...
				<div class="title">Patients</div>
					<div>
						...
						if($bool){
							echo '<a href="infoPatient.php"><b>+ d\'infos</b></a></center>';
						}
