	...
	<h3>Bonjour <?php echo $_SESSION['surname']." ".$_SESSION['name'] ?></h3>
	  ...
	  <center>
        <p class="col1"><b>Données personnelles. </b></p>
         <span class="cont_phone"><?php $_SESSION['surname']." ".$_SESSION['name'] ?> </span><br>
	  ...
	  <a href="supprimerQuestionnaire.php" class="reserv"><span>GO</span>-  Supprimer mon questionnaire</a>
    </div>
    <div class="grid_4">
      <div class="hours">
