						...
						<center>
							<fieldset><BR>
								<fieldset>
									...
									<span class="cont_phone"><?php echo "Id:".$_SESSION['id']."</span>" ?></span>
								</fieldset><BR>
								<fieldset>
									<legend>Votre compte</legend><BR>
									<span class="cont_phone"><?php echo "Mail: ".$_SESSION['mail']."</span>" ?></span><br><BR>
									<span class="cont_phone"><?php echo "Mot de passe: ".$_SESSION['pwd']."</span>" ?></span><br>
								</fieldset><BR>
								<fieldset>
						...
						<justify>
							<BR><fieldset>
								<legend>Information:</legend><BR>
									Votre médecin vous propose de remplir un questionnaire avant votre consultation.<BR>
									Veuillez remplir ce formulaire en cliquant sur le lien ci-dessous.<BR> 
									Une fois ce questionnaire saisi, votre médecin l'examinera afin de convenir d'un rendez-vous.<BR> 
									Après consulation, vous pourrez accéder à son compte rendu sur cette page.<BR><BR>
									Pour plus d'informations, rendez-vous <span class="cont_phone"><a href="index-5.php">ici</a></span> où vous trouverez nos coordonnées. <br>
									À Bientôt !
							</fieldset>
						</justify>
						<center>
